...
public class SimplePlayer : NetworkBehaviour
{
    ...
    [Header("Camera")]
    [SerializeField] private Vector3 cameraFollowOffset = new Vector3(0, 1.5f, 0);
    ...
    public override void FixedUpdateNetwork()
    {
        ...
        {
            Quaternion camYawRotation = Quaternion.Euler(0f, inputData.cameraYaw, 0f);
            ...
            // 이동 분리
            Vector3 horizontalMove = new Vector3(move.x * moveSpeed, 0f, move.y * moveSpeed);
    ...
    private void Fire()
    {
        ...
        NetworkObject bulletObj = Runner.Spawn(bulletPrefab,
            spawnPos,
            spawnRot,
    ...
    private void LateUpdate()
    {
        ...
        // yaw는 루트가 담당
        cameraRoot.transform.localRotation = Quaternion.Euler(0, cameraYaw - transform.eulerAngles.y, 0);
    ...
    private bool TryDropHeldBox()
    {
        ...
        PickableBox box = HeldBox.GetComponentInChildren<PickableBox>();
